...
const SPECIES_DATA = [
  { name:'Banyan',    title:'The Tree of Generations', story:'Massive canopy. Deep roots. A living shelter for generations and wildlife alike.',              benefits:['Highway shade','Wildlife support','Long lifespan'],    img:'/trees/tree-banyan.webp',    fallback:'https://images.unsplash.com/photo-1592150621744-aca64f48394a?w=800&q=80' },
  { name:'Neem',      title:'The Healing Tree',         story:"Nature's pharmacy. Purifies air, enriches soil and supports life around it.",                  benefits:['Air purification','Medicinal value','Pest resistance'], img:'/trees/tree-neem.webp',      fallback:'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=800&q=80' },
  { name:'Rain Tree', title:'The Giant Canopy',         story:'Creates extraordinary cooling shade across entire streets and communities.',                   benefits:['Massive shade','Fast growth','Urban cooling'],           img:'/trees/tree-raintree.webp',  fallback:'https://images.unsplash.com/photo-1448375240586-882707db888b?w=800&q=80' },
  { name:'Honge',     title:'The Resilient Native',     story:'Exceptionally tough and adaptive. Thrives where others struggle.',                             benefits:['Drought resistant','Soil enrichment','Native species'],  img:'/trees/tree-honge.webp',     fallback:'https://images.unsplash.com/photo-1425913397330-cf8af2ff40a1?w=800&q=80' },
  { name:'Ashoka',    title:'The Graceful Sentinel',    story:'Tall, narrow and elegant. A natural screen of living green year-round.',                       benefits:['Road beautification','Narrow footprint','Air cleaner'], img:'/trees/tree-ashoka.webp',    fallback:'https://images.unsplash.com/photo-1466692476868-aef1dfb1e735?w=800&q=80' },
  { name:'Gulmohar',  title:'The Flame of Nature',      story:'Transforms the landscape with spectacular red-orange blooms every summer.',                    benefits:['Seasonal beauty','Roadside appeal','Shade canopy'],      img:'/trees/tree-gulmohar.webp',  fallback:'https://images.unsplash.com/photo-1509391366360-2e959784a276?w=800&q=80' },
  { name:'Jamun',     title:'The Community Tree',       story:'Pollution-resistant with edible black plum fruits loved by birds and people.',                 benefits:['Pollution resistant','Edible fruits','Wildlife food'],   img:'/trees/tree-jamun.webp',     fallback:'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=800&q=80' },
  { name:'Amaltas',   title:'The Golden Shower',        story:'Brilliant yellow blooms cascade every April — a spectacular urban spectacle.',                 benefits:['Golden blooms','Ornamental beauty','Shade support'],     img:'/trees/tree-amaltas.webp',   fallback:'https://images.unsplash.com/photo-1490750967868-88df5691cc9f?w=800&q=80' },
  { name:'Arjun',     title:'The Fast Grower',          story:"One of India's fastest-growing shade trees with powerful medicinal bark.",                     benefits:['Fast growth','Medicinal bark','Dense shade'],            img:'/trees/tree-arjun.webp',     fallback:'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&q=80' },
  { name:'Imli',      title:'The Ancient Root',         story:'Deep, strong roots that have anchored Indian villages for centuries.',                         benefits:['Deep roots','Edible fruit','Erosion control'],           img:'/trees/tree-imli.webp',      fallback:'https://images.unsplash.com/photo-1511497584788-876760111969?w=800&q=80' },
  { name:'Mahogany',  title:'The Wind Warrior',         story:'Straight trunk, dense canopy, remarkably wind-resistant in urban environments.',               benefits:['Wind resistant','Straight form','Carbon capture'],       img:'/trees/tree-mahogany.webp',  fallback:'https://images.unsplash.com/photo-1448375240586-882707db888b?w=800&q=80' },
  { name:'Atti',      title:'The Wildlife Magnet',      story:'A small tree with massive ecological impact — attracts birds, bees and butterflies.',          benefits:['Wildlife habitat','Attracts pollinators','Native eco'],  img:'/trees/tree-atti.webp',      fallback:'https://images.unsplash.com/photo-1425913397330-cf8af2ff40a1?w=800&q=80' },
]
      ...
      <section className="dp-sec dp-sec--white">
        <div className="dp-c">
          ...
          <div className="dp-gallery">
            {[
              {img:'/trees/gallery-sapling.webp',fb:'https://images.unsplash.com/photo-1509391366360-2e959784a276?w=500&q=80',l:'🌱 Day 1 — Sapling planted',s:'GPS-tagged, QR code attached'},
              {img:'/trees/gallery-growing.webp',fb:'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=500&q=80',l:'🌿 Month 6 — Growing strong',s:'AI health score: 94%'},
              {img:'/trees/gallery-canopy.webp',fb:'https://images.unsplash.com/photo-1448375240586-882707db888b?w=500&q=80',l:'🌳 Year 3 — Full canopy',s:'22kg CO₂ offset/year'},
            ].map(g=>(
