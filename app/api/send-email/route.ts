          ...
          <tr>
            <td style="padding:32px 40px;">
              ...
              <div style="background:#f9fafb;border-radius:12px;padding:16px 20px;text-align:center;">
                ...
                <a href="https://wa.me/?text=I%20just%20planted%20a%20tree%20with%20EcoTree%20Impact%20Foundation!%20https%3A%2F%2Fecotrees.org"
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:white;border-radius:16px;overflow:hidden;max-width:600px;width:100%;">
          ...
          <tr>
            <td style="padding:32px 40px;">
              <p style="margin:0 0 16px;font-size:16px;color:#374151;">Hi <strong>${donor.name}</strong>,</p>
              <p style="margin:0 0 24px;font-size:15px;color:#6B7280;line-height:1.6;">
                We have received your CSR proposal request for <strong>${donor.company}</strong>. Our team will reach out within <strong>24 hours</strong> with a customised proposal.
              </p>
              <div style="background:#f0fdf4;border:1px solid #86efac;border-radius:12px;padding:20px 24px;margin-bottom:24px;">
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td style="padding:4px 0;font-size:14px;font-weight:600;color:#374151;text-align:right;">${donor.company}</td>
                  </tr>
                  <tr>
                    <td style="padding:4px 0;font-size:14px;color:#6B7280;">Budget range</td>
                    <td style="padding:4px 0;font-size:14px;font-weight:600;color:#374151;text-align:right;">${donor.budget}</td>
                  </tr>
                  <tr>
                    <td style="padding:4px 0;font-size:14px;color:#6B7280;">Trees requested</td>
                    <td style="padding:4px 0;font-size:14px;font-weight:600;color:#374151;text-align:right;">${donor.trees}</td>
                  </tr>
                  <tr>
                    <td style="padding:4px 0;font-size:14px;color:#6B7280;">Project interests</td>
                    <td style="padding:4px 0;font-size:14px;font-weight:600;color:#374151;text-align:right;">${donor.interests}</td>
                  </tr>
                </table>
              </div>
              <div style="text-align:center;margin-bottom:24px;">
                <a href="https://ecotrees.org/csr-ngo" style="display:inline-block;background:#1A3C34;color:white;font-size:15px;font-weight:700;padding:14px 32px;border-radius:999px;text-decoration:none;">
                  Visit EcoTree →
                </a>
              </div>
            </td>
