        ...
        <tr>
          <td style="padding:32px 40px;">
            ...
            <p style="margin:0 0 24px;font-size:15px;color:#6B7280;line-height:1.6;">
              Thank you for your contribution! Your support is making Bangalore greener.
              </p>
            ${treeDetailsSection}
...
<body style="margin:0;padding:0;background:#f4f4f4;font-family:'Helvetica Neue',Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f4f4f4;padding:32px 16px;">
    ...
    } else if (type === 'miyawaki_assigned') {
      subject = `🏙️ Your Miyawaki Forest has been assigned — ${donor.forest_name}`
      html = `<!DOCTYPE html>
<html><head><meta charset="utf-8" /></head>
<body style="margin:0;padding:0;background:#f4f4f4;font-family:'Helvetica Neue',Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f4f4f4;padding:32px 16px;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background:white;border-radius:16px;overflow:hidden;max-width:600px;width:100%;">
        <tr><td style="background:#1A3C34;padding:32px 40px;text-align:center;">
          ...
          <div style="font-size:13px;font-weight:600;letter-spacing:0.1em;text-transform:uppercase;color:#97BC62;margin-bottom:8px;">EcoTree Impact Foundation</div>
          <h1 style="margin:0;font-size:24px;font-weight:700;color:white;">Your Miyawaki Forest<br/>is Ready! 🌿</h1>
        </td></tr>
        <tr><td style="padding:32px 40px;">
          <p style="margin:0 0 16px;font-size:16px;color:#374151;">Hi <strong>${donor.name}</strong>,</p>
          <p style="margin:0 0 24px;font-size:15px;color:#6B7280;line-height:1.6;">Great news! Your Miyawaki forest has been assigned. You can now track your forest on your dashboard.</p>
          <div style="background:#f0fdf4;border:1px solid #86efac;border-radius:12px;padding:20px 24px;margin-bottom:24px;">
            <div style="font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:0.08em;color:#166534;margin-bottom:12px;">Your Forest Details</div>
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr><td style="padding:4px 0;font-size:14px;color:#6B7280;">Forest name</td><td style="padding:4px 0;font-size:14px;font-weight:600;color:#1A3C34;text-align:right;">${donor.forest_name}</td></tr>
              ...
              <tr><td style="padding:4px 0;font-size:14px;color:#6B7280;">Trees target</td><td style="padding:4px 0;font-size:14px;font-weight:600;color:#374151;text-align:right;">${donor.trees_target}</td></tr>
              <tr><td style="padding:4px 0;font-size:14px;color:#6B7280;">Species</td><td style="padding:4px 0;font-size:14px;font-weight:600;color:#374151;text-align:right;">${donor.species_count}+ native species</td></tr>
            </table>
          </div>
          <div style="background:#1A3C34;border-radius:12px;padding:20px 24px;margin-bottom:24px;">
            <div style="font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:0.08em;color:#97BC62;margin-bottom:12px;">🔐 Your Dashboard Login</div>
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr><td style="padding:4px 0;font-size:14px;color:rgba(255,255,255,0.6);">Dashboard URL</td><td style="padding:4px 0;font-size:14px;font-weight:600;color:white;text-align:right;">ecotrees.org/miyawaki-dashboard</td></tr>
              <tr><td style="padding:4px 0;font-size:14px;color:rgba(255,255,255,0.6);">Email</td><td style="padding:4px 0;font-size:14px;font-weight:600;color:white;text-align:right;">${donor.email}</td></tr>
              <tr><td style="padding:4px 0;font-size:14px;color:rgba(255,255,255,0.6);">Password</td><td style="padding:4px 0;font-size:14px;font-weight:600;color:#97BC62;text-align:right;">${donor.password} (change after login)</td></tr>
            </table>
          </div>
          <div style="text-align:center;">
            <a href="https://ecotrees.org/miyawaki-dashboard" style="display:inline-block;background:#7C3AED;color:white;font-size:15px;font-weight:700;padding:14px 32px;border-radius:999px;text-decoration:none;">🏙️ View Forest Dashboard →</a>
          </div>
        </td></tr>
        <tr><td style="background:#f9fafb;padding:20px 40px;text-align:center;border-top:1px solid #e5e7eb;">
          <div style="font-size:12px;color:#9ca3af;">EcoTree Impact Foundation · Bangalore · 80G Approved</div>
        </td></tr>
      </table>
    </td></tr>
  </table>
